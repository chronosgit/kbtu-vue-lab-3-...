<script setup lang="ts">
	...
	const age = ref('');
	const onAgeInputEnterClick = (newAge: string) => console.log(newAge);
</script>
...
<template>
	...
	>
		...
		<main class="px-4">
			<h1 class="text-right font-tnr text-6xl text-white">Profile</h1>
			...
			<div class="flex items-center justify-between">
				<div class="">
					...
					<div class="space-y-2 font-tnr">
						...
						<RegularTextInput
							v-else
							v-model:model-value="age"
							placeholder="Add your age"
							@on-enter-key="onAgeInputEnterClick"
						/>

						<!-- <p>Location: {{ user?.location }}</p>

						<p>Activity: for now</p>
